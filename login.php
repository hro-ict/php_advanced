...
showConfirmButton: false
        ...
        //$msg= '<div class="container ,t-5 pt-5"><h4 class="text-center mt-5 ms-5 "><span class="alert alert-info ">Login successfully</span></h4></div>';
...
<div class="container mt-5 pt-5">
    <h1 class="text-center "><span class="badge bg-primary">Login</span></h1>
</div>
