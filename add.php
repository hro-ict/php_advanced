...
<div class="row p-5 bg-secondary">
    <div class="col-md-12 head">
        ...
        <div class="container col-6" style="margin-right: 25%; margin-left: 25%">
             <span class="badge bg-danger ">
            <h3 class=" gw-bold text-white">Add New Blog</h3>
        </span>
        </div>
    ...
    <div class="col-p-5">
        <form method="post" action="action.php" class="form">
            ...
            <input type="submit" class="form-control btn mt-3 btn-primary " name="submit" value="Add Blog"/>
        </form>
    </div>
</div>
